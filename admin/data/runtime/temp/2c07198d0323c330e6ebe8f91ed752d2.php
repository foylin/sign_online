...
<body>
    <div class="wrap js-check-wrap">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="<?php echo url('admin_index/add'); ?>">添加员工</a></li>
        </ul>
        <form action="<?php echo url('admin_index/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
            <div class="row">
                <div class="col-md-9">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="post[mobile]" id="title" required value=""
                                    placeholder="请输入手机号码" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" style="width:400px;"  value=""
                                    ...
                                    readonly />
                                <input class="form-control" type="hidden" value="" name="post[categories_vague]" id="js-categories-id-input-vague" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" style="width:400px;"  value=""
                                    ...
                                    readonly />
                                <input class="form-control" type="hidden" value="" name="post[categories_role]" id="js-categories-id-input-role" />
                            </td>
                        </tr>
                        <tr>
                            <th>岗位调动详情</th>
                    ...
                    <?php 
    \think\Hook::listen('portal_admin_article_edit_view_main',$temp5bfd76711cb82,null,false);
 ?>
                ...
                <div class="col-md-3">
                    ...
                    <?php 
    \think\Hook::listen('portal_admin_article_edit_view_right_sidebar',$temp5bfd76711cb99,null,false);
 ?>
                </div>
            </div>
        </form>
