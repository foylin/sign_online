<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"themes/admin_simpleboot3/seal/admin_index/add.html";i:1540736948;s:77:"/var/www/sign_online/admin/public/themes/admin_simpleboot3/public/header.html";i:1540662485;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminIndex/index'); ?>">行政公章列表</a></li>
        <li class="active"><a href="<?php echo url('AdminIndex/add'); ?>">添加行政公章</a></li>
    </ul>
    <div class="row margin-top-20">
        ...
        <div class="col-md-6">
            <form class="js-ajax-form" action="<?php echo url('AdminIndex/addPost'); ?>" method="post">
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <div class="form-group">
                            <label for="input-name"><span class="form-required">*</span>行政公章名称</label>
                            <div>
                        ...
                        <div class="form-group">
                            <label for="input-description">公章图片</label>
                            <div>
