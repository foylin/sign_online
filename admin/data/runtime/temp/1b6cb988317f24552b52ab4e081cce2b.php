<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"themes/admin_simpleboot3/portal/admin_article/add.html";i:1540714654;s:77:"/var/www/sign_online/admin/public/themes/admin_simpleboot3/public/header.html";i:1540662485;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="<?php echo url('AdminArticle/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_main',$temp5beda6864cdbf,null,false);
 ?>
            ...
            <div class="col-md-3">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_right_sidebar',$temp5beda6864cdc8,null,false);
 ?>
            </div>
        </div>
    </form>
