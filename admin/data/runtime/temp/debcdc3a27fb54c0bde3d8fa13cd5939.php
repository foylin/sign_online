<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"themes/admin_simpleboot3/identity/admin_index/index.html";i:1540721110;s:77:"/var/www/sign_online/admin/public/themes/admin_simpleboot3/public/header.html";i:1540662485;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('AdminIndex/index'); ?>">员工身份列表</a></li>
        <li><a href="<?php echo url('AdminIndex/add'); ?>">添加员工身份</a></li>
    </ul>
