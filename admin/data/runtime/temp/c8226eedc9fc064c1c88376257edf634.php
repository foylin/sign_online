<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/identity/admin_index/edit.html";i:1540720602;s:77:"/var/www/sign_online/admin/public/themes/admin_simpleboot3/public/header.html";i:1540662485;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminIndex/index'); ?>">模糊岗位列表</a></li>
        <li><a href="<?php echo url('AdminIndex/add'); ?>">添加模糊岗位</a></li>
        <li class="active"><a>编辑模糊岗位</a></li>
    </ul>
