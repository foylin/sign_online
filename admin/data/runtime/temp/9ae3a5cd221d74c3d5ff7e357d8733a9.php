<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"themes/admin_simpleboot3/protocol/admin_index/add.html";i:1543367297;s:77:"/var/www/sign_online/admin/public/themes/admin_simpleboot3/public/header.html";i:1540625985;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="<?php echo url('AdminIndex/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_main',$temp5bfe05bc76bd7,null,false);
 ?>
            ...
            <!-- <div class="col-md-3">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_right_sidebar',$temp5bfe05bc76c27,null,false);
 ?>
            </div> -->
        </div>
    </form>
