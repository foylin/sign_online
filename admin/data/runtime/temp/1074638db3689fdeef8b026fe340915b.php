<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"themes/admin_simpleboot3/seal/admin_index/edit.html";i:1540737098;s:77:"/var/www/sign_online/admin/public/themes/admin_simpleboot3/public/header.html";i:1540662485;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminIndex/index'); ?>">行政公章管理</a></li>
        <li><a href="<?php echo url('AdminIndex/add'); ?>">添加行政公章</a></li>
        <li class="active"><a>编辑行政公章</a></li>
    </ul>
    <div class="row margin-top-20">
        ...
        <div class="col-md-6">
            <form class="js-ajax-form" action="<?php echo url('AdminIndex/editPost'); ?>" method="post">
